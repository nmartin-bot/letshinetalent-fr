...
import { FileText, Mail, ScanSearch, FolderOpen, Calendar, BookOpen, ArrowRight } from 'lucide-react'

export const Route = createFileRoute('/client/apprenant/')({
  component: ApprenantHome,
})
...
const TOOLS = [
  ...
  { href: '/client/apprenant/formations', icon: BookOpen, color: 'bg-violet-50 text-violet-600', title: 'Mes formations', desc: 'Accédez au contenu de vos sessions de formation.' },
  { href: '/client/apprenant/documents', icon: FolderOpen, color: 'bg-amber-50 text-amber-600', title: 'Mes documents', desc: 'Retrouvez tous les fichiers partagés par votre formateur.' },
  { href: '/client/apprenant/agenda', icon: Calendar, color: 'bg-cyan-50 text-cyan-600', title: 'Mon agenda', desc: 'Consultez vos prochains rendez-vous et sessions.' },
]
...
function ApprenantHome() {
  return (
    <div className="flex-1 overflow-auto p-8">
      ...
      <p className="text-sm text-gray-500 mb-8">Accédez à vos outils, vos formations et votre programme.</p>
